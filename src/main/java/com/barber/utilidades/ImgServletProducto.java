 ...
 * @author juan
 */
@WebServlet(name = "ImgServletProducto", urlPatterns = {"/ImgServletProducto/*"})
public class ImgServletProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ImgServletProducto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ImgServletProducto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!archivoNombre.isEmpty()) {
            File carpeta = new File("C:\\ubs\\productos\\fotoProductos\\" + archivoNombre);
