 ...
 * @author juan
 */
@WebServlet(name = "ImgServletServicio", urlPatterns = {"/ImgServletServicio/*"})
public class ImgServletServicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ImgServletServicio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ImgServletServicio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!archivoNombre.isEmpty()) {
            File carpeta = new File("C:\\ubs\\servicios\\fotoServicios\\" + archivoNombre);
