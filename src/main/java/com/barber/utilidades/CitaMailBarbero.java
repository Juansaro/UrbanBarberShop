 ...
 * @author juan
 */
public class CitaMailBarbero {
    
    public static void correoCita(String nombreBarbero, String apellidoBarbero, String nombreCliente, String apellidoCliente, String correoPara, Date fechaCita) {
        ...
        try {
            ...
            mensage.setSubject("Hola " +nombreBarbero + " Un cliente te ha solicitado una cita.");
            mensage.setContent("<center> "
                    ...
                    + "</center>"
                    + "<br/>"
                    + "<h1> Hola, "+ nombreBarbero + " " + apellidoBarbero +" </h1>"
                    + "Tienes una cita agendada para el día " + fechaCita
                    + "<br/>"
                    + "con el cliente " + nombreCliente + " " + apellidoCliente
                    + "<br/>",
                    "text/html");
